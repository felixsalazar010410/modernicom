...
<!--Contenido-->
    ...
    /* .panel-primary {
      ...
      <div class="container">
          ...
          <h4>Descargar Formatos Nokia 2021</h4>
    ...
    <div class="panel-body">
      ...
      <table class="table">
        ...
        <tbody>
      <?php
      $archivos = scandir("formatosnokia");
      $num=0;
      ...
      <p>  
          ...
          <tr>
            ...
            <td><a title="Descargar Archivo" href="formatosnokia/<?php echo $archivos[$i]; ?>" download="<?php echo $archivos[$i]; ?>" style="color: gren; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a></td>
      ...
      <script type="text/javascript" src="scripts/formatosnokia.js"></script>
      </body>
      </html>
                        </div><!-- /.box -->
                    </div><!-- /.col -->
