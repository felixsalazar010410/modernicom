              ...
              <div class="col-md-12">
                  ...
                  <?php require 'navegadorHerramienta.php'; ?>
                    <div class="box-header with-border">
                          <h1 class="box-title">Ingreso <button class="btn btn-success" id="btncomprar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> 
                           <a href="../reportes/rptingresos.php" target="_blank"></a></h1>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Seleccione una Herramienta</h4>
        </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/ingresoHerramienta.js"></script>
<?php 
}
ob_end_flush();
?>
