...
function init(){
	...
	$.post("../ajax/sitemankco.php?op=selectCategoria", function(r){
	            $("#idcategoria").html(r);
...
function listar()
{
	...
	{   
		...
		"ajax":
				...
				{
					url: '../ajax/sitemankco.php?op=listar',
					type : "get",
					dataType : "json",
					columnDefs:[{
						targets: "_all",
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/sitemankco.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
{
	$.post("../ajax/sitemankco.php?op=mostrar",{idsitewom : idsitewom}, function(data, status)
	{
...
function desactivar(idsitewom)
{
	bootbox.confirm("¿Está Seguro de desactivar el artículo?", function(result){
		if(result)
        {
        	$.post("../ajax/sitemankco.php?op=desactivar", {idsitewom : idsitewom}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
...
function activar(idsitewom)
{
	bootbox.confirm("¿Está Seguro de activar el Artículo?", function(result){
		if(result)
        {
        	$.post("../ajax/sitemankco.php?op=activar", {idsitewom : idsitewom}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
